...
- "SELECT c.first_name, c.last_name, t.text FROM contacts c JOIN tasks t ON t.contact_id = c.id WHERE t.done_date IS NULL"`,
...
- Creating new contacts, deals, tasks, or notes
