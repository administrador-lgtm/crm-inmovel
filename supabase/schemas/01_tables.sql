...
create table public.visitas (
    ...
    -- Plain text, no FK: a visit may target an OWN property (propiedades.id) OR
    -- any external listing ("URL libre"), whose id/code is not in propiedades.
    propiedad_id text,
    ...
    -- Self-contained snapshot for external / "URL libre" visits (external
    -- inventory is volatile, so we don't FK to it).
    propiedad_fuente text default 'propia',
    propiedad_nombre text,
    propiedad_url text,
    propiedad_url_maps text
);
