...
create table public.lead_propiedad (
    ...
    relacion text not null check (relacion in ('match_bot', 'pregunto', 'visito')),
...
create table public.conversaciones (
    ...
    lead_id bigint not null references public.contacts(id) on delete cascade,
    rol text not null check (rol in ('lead', 'bot')),
    texto text not null,
